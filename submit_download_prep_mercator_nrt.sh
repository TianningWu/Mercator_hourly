...
hostname
python /ourdisk/hpc/ai2es/twu27/srcdata/Mercator_hourly/mercator_6hourly_avg.py "${mercator_file}" /ourdisk/hpc/ai2es/twu27/srcdata/Mercator_hourly/Mercator_IC.nc
